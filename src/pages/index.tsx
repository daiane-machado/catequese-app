...
export default function Home({data}: any) {
 ...
 // console.log(currentMonthName)
  ...
  const { filterDatas } = useGlobalContext()
  const lowerSerarch = filterDatas.toLowerCase()
  const catechism = data.filter((item: any) => item.data.title.toLowerCase().includes(lowerSerarch))

  
  return (
    
    <div className={styles.wrapper}>
      <Dropdown dataCatechism={catechism}/>
      <Head>
